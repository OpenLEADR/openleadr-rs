...
#[schema(format = "uri", example = "https://zalando.github.io/problem/constraint-violation")]
...
pub struct Problem {
    ...
    #[schema(example = 503, value_type = u16, required = false, minimum = 100, exclusive_maximum = 600)]
    #[serde(with = "status_code_serialization")]
    pub status: StatusCode,
    /// A human-readable explanation specific to this occurrence of the problem.
    #[schema(nullable = false, example = "Connection to database timed out")]
