...
fn validate_value(value_type: &EventType, value: &Value) -> Result<(), ValidationError> {
    match (value_type, value) {
        ...
        (EventType::ControlSetpoint, _) => Ok(()),                 // TODO "depends"
        (EventType::ExportPrice, Value::Number(_)) => Ok(()),      // float
        (EventType::GHG, Value::Number(_)) => Ok(()),              // float
        (EventType::Curve, Value::Number(_)) => Ok(()),            // TODO "pairs of floats"
        (EventType::OLS, Value::Number(_)) => Ok(()),              // TODO 0.0 to 1.0
        ...
        (EventType::CTA2045Reboot, Value::Integer(_)) => Ok(()),   // TODO 0 = SOFT, 1 = HARD
        (EventType::CTA2045SetOverrideStatus, Value::Integer(_)) => Ok(()), // TODO 0 = No Override, 1 = Override
